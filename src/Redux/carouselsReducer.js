...
let initialState = {
    carouselsContact: [
        {
            id: 0, imgServices: "/img/biznes1.png", textServicesH2: "Бизнес-мероприятия",
        ...
        {
            id: 1, imgServices: "/img/biznes2.png", textServicesH2: "Cемейные- мероприятия",
        ...
        {
            id: 2, imgServices: "/img/biznes3.png", textServicesH2: "Ночные- мероприятия",
        ...
        {
            id: 3, imgServices: "/img/biznes6.png", textServicesH2: "Спортивные- мероприятия",
        ...
        {
            id: 4, imgServices: "/img/biznes5.png", textServicesH2: "Hr- мероприятия",
        ...
        {
            id: 5, imgServices: "/img/biznes4.png", textServicesH2: "Индивидуальные мероприятия",
